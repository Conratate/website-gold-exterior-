...
// The last two years of months, newest first — a reviewer picks when we did
// the work so the owner can match it against the books before publishing.
export function recentJobMonths(now = new Date(), count = 24) {
  const months = [];
