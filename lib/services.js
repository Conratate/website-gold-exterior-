...

  {
    ...
    price: ({ vehicle, package: pkg, length, scope, condition }) => {
      ...
      if (vehicle === "boat") {
        ...
        // actually cost time.
        const RATES = {
          light:    { topside: [1.65, 1.9],   hull: [1.5, 1.7],   both: [3.05, 3.5] },
          standard: { topside: [1.9, 2.15],   hull: [1.7, 1.95],  both: [3.5, 4.0] },
          heavy:    { topside: [2.5, 2.9],    hull: [2.25, 2.65], both: [4.65, 5.45] },
        };
