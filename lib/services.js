...
export const SERVICES = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        // Real-world reference points per surface so "Small/Medium/Large"
        // isn't a blind guess.
        optionHints: (a) => {
          const bySurface = {
            driveway: {
              small: "Up to ~600 sq ft — a 1–2 car driveway",
              medium: "~600–1,200 sq ft — 3-car or extended driveway",
              large: "1,200+ sq ft — estate drive, RV pad or courtyard",
            },
            sidewalk: {
              small: "Up to ~1,500 sq ft of walkway",
              medium: "~1,500–3,500 sq ft — storefront frontage",
              large: "3,500+ sq ft — full block or plaza",
            },
            fence: {
              small: "Up to ~100 linear ft — a typical side yard",
    ...
    sizingGuide: {
      ...
      rows: [
        {
          tier: "Small",
          cells: ["Up to ~600 sq ft", "Up to ~1,500 sq ft", "Up to ~100 linear ft"],
        },
        {
          tier: "Medium",
...

  {
    ...
    questions: [
      ...
      },
      {
        ...
        optionHints: () => ({
          small: "Up to ~2,000 sq ft — small storefront or office frontage",
          medium: "~2,000–5,000 sq ft — restaurant patio, mid-size lot",
          large: "~5,000–12,000 sq ft — full parking lot or building face",
          xl: "12,000+ sq ft — garage decks, campuses, plazas",
        }),
        sizer: () => ({
          mode: "area",
          prompt: "A rough length × width is all we need — we confirm exact footage on site.",
          tiers: [
            { value: "small", max: 2000 },
            { value: "medium", max: 5000 },
    ...
    sizingGuide: {
      ...
      rows: [
        { tier: "Small", cells: ["Up to ~2,000 sq ft"] },
        { tier: "Medium", cells: ["~2,000–5,000 sq ft"] },
        { tier: "Large", cells: ["~5,000–12,000 sq ft"] },
...

  {
    ...
    sizingGuide: {
      ...
      rows: [
        { tier: "Small", cells: ["Single tag, up to 5 sq ft"] },
        { tier: "Medium", cells: ["Up to 20 sq ft"] },
...

  {
    ...
    price: ({ vehicle, package: pkg, length }) => {
      ...
      if (vehicle === "boat") {
        ...
        const tiers = {
          under20:       [329,  379],
          twenty_thirty: [559,  649],
          thirty_forty:  [849,  999],
          forty_plus:    [1359, 1599],
        };
