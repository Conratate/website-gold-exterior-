...
export const SERVICES = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "radio",
        options: [
          { value: "small", label: "Small (1–2 car driveway / short span)" },
          { value: "medium", label: "Medium (3–4 car / standard yard)" },
          { value: "large", label: "Large (estate / full perimeter)" },
        ],
      },
    ],
    price: ({ surface, size }) => {
...

  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "radio",
        options: [
          { value: "small", label: "Small (under 2,500 sq ft)" },
          { value: "medium", label: "Medium (2,500 – 7,500 sq ft)" },
          { value: "large", label: "Large (7,500 – 15,000 sq ft)" },
          { value: "xl", label: "XL / Estate (15,000+ sq ft)" },
        ],
      },
    ],
    price: ({ type, sqft }) => {
