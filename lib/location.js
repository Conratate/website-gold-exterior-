...
// neighborhood or a service area reads from here, so the answer stays the same
...
export const BUSINESS = {
  ...
  // We're a mobile crew, not a storefront — the neighborhood is where the
  // truck lives, not an address customers should drive to.
  ...
  base: "Rex Manor, Mountain View",
  baseLong: "Rex Manor, Mountain View, CA",
